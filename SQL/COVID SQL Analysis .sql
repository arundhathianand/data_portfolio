...
ALTER TABLE sreeTest.CovidVaccinations
ADD COLUMN recordDate date AFTER location

SELECT * from sreeTest.CovidVaccinations

UPDATE sreeTest.CovidVaccinations
...
FROM sreeTest.CovidDeaths covdeath
JOIN sreeTest.CovidVaccinations covac
